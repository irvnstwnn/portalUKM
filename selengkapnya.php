...
<nav class="navbar navbar-expand-lg bg-body-tertiary navigasi">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav m-auto menu">
                    ...
                    <li class="nav-item ps-5 pe-5">
                        <a class="nav-link" href="./tentangUkm.php">Tentang UKM</a>
                    </li>
                    <li class="nav-item ps-5 pe-5">
                        <a class="nav-link active color-kuning" href="./Pengumuman.php">Pengumuman</a>
                    </li>
    ...
    <div class="d-flex justify-content-center">
        <h2 style="font-size: 40px; font-weight: 500;">Pengumuman Penerimaan UKM Tahun 2023</h2>
    </div><br>
    ...
    <div class="d-flex justify-content-center">
        <div style="width: 80%;">
            ...
            Beatae repellat sint suscipit quibusdam distinctio, eius modi accusamus, perspiciatis totam explicabo, aliquam harum nemo provident nulla quasi ullam libero similique rerum ea illo. Magni ut rem doloremque error delectus! Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam explicabo voluptatum recusandae vitae id ut eveniet nulla voluptatibus porro numquam sunt asperiores rem aliquid, est pariatur corrupti consequatur vel eligendi. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aliquam quod, eligendi explicabo consequatur sed odio illum repellendus sit a, minus dolorem aut quam laboriosam inventore sint consequuntur perspiciatis facere. Dolor? Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis, nam nesciunt. Libero, fugiat atque. Repellendus fuga quam ad cupiditate repellat nihil nesciunt, dolorem incidunt maiores libero et perspiciatis velit? Alias?
        </div>
    </div>
