...
<body>
    ...
    <div class="container">
        ...
        <div style="padding-right:300px;" class="container d-flex justify-content-end">
            <div>
                <a href="./tentangUkm.php" class="btn-prev"><button style="width: 80px; height: 50px; font-size:20px; background-color:orange; border-top-left-radius: 10px; border-bottom-left-radius: 10px;"> prev </button></a>
                <a href="./tentangUkm3.php" class="btn-prev"><button style="width: 80px; height: 50px; font-size:20px; background-color:orange; border-top-right-radius: 10px; border-bottom-right-radius: 10px;"> next </button></a>
